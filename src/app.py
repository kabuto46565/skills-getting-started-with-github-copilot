...
activities = {
    ...
    "Art Club": {
        "description": "Explore painting, drawing, and other creative art projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["isabella@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, stage design, and prepare performances",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu"]
    },
    "Mathletes": {
        "description": "Work on advanced math problems and compete in math competitions",
